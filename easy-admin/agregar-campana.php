		...
		<div id="container">
			<div id="example">
				<?php			
					...
					*/			
					echo "<form class=\"my-hero-form\" method=\"POST\" action=\"procesar-agregar-campana.php\">";
					echo "<label>Nombre campaña:</label> <input type=\"text\" name=\"campana_name\" required>";					
					echo "<input type=\"submit\" value=\"Aceptar\">";
					echo "<a class=\"cancel\" href=\"admin-campanas.php\">Cancelar</a>";
					echo "</form>";
				?>
			</div>			
		</div>		
