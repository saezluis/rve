									...
									//echo "<div class=\"content-caja-mensajes\">";
										...
										*/
										...
										echo "<div class=\"cmt-container\">";
											...
											echo "<div class=\"new-com-bt\">";
												echo "<span>Escribe tu comentario ...</span>";
											echo "</div>";
											echo "<div class=\"new-com-cnt\">";
												echo "<textarea class=\"the-new-com\"></textarea>";
												echo "<input type=\"text\" id=\"mail-com\" name=\"mail-com\" value=\"$id_foto\" hidden=hidden />";
												echo "<div class=\"bt-add-com\">Enviar comentario</div>";
												echo "<div class=\"bt-cancel-com\">Cancelar</div>";
											echo "</div>";
