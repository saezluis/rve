      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Agregar proveedores</h4>";
					...
					*/			
					echo "<form class=\"my-hero-form\" method=\"POST\" action=\"procesar-agregar-proveedor.php\">";
					echo "<label>Nombre proveedor:</label> <input type=\"text\" name=\"proveedor_name\" required>";					
					echo "<input type=\"submit\" value=\"Aceptar\">";
					echo "<a class=\"cancel\" href=\"admin-proveedores.php\">Cancelar</a>";
					echo "</form>";
				?>
			</div>			
		</div>		
