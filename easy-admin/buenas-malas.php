			...
			<div id="list-users">
				<?php
					...
					if($id_campana!=''){
						...
						$registrosFotos = mysqli_query($conexion,"SELECT * FROM fotos_practicas WHERE id_campana = '$id_campana' ") or die("Problemas en el select de campana: ".mysqli_error($conexion));
						
						echo "<ul>";
								echo "<li><img src=\"images/$nombre_foto\" width=\"200px\" height=\"200px\" ></li>";
						echo "</ul>";
					}
