    ...
    <div class="ed-container">
      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="list-users">
				<?php			
					echo "<a href=\"consultar-proveedores.php\">Consultar proveedores</a>";
					echo "<a href=\"agregar-proveedores.php\">Agregar proveedores</a>";
					echo "<a href=\"modificar-proveedores.php\">Modificar proveedores</a>";
					echo "<a href=\"eliminar-proveedores.php\">Eliminar proveedores</a>";
				?>
			</div>			
		</div>		
     </div>
