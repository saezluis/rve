...
<html ng-app lang="es">
  ...
  <body>
	<?php
		...
		$registrosMembers = mysqli_query($conexion,"SELECT * FROM exhibicion") or die("Problemas en el select de sala: ".mysqli_error($conexion));
		...
		$ssql = "SELECT * FROM exhibicion LIMIT " . $inicio . "," . $TAMANO_PAGINA; 
		//echo $ssql;
      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Modificar proveedores</h4>";
					echo "<p>Seleccione el ID del proveedor que desea modificar:</p>";
						...
						echo "<tbody>";
							...
							while($reg=mysqli_fetch_array($rss)){
								...
								echo "<tr>";
									...
									echo "<td><a class=\"equis\" href=\"modificar-proveedor-detalle.php?id_send=",urlencode($id_exhibicion)," \">$id_exhibicion</a></td>";
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='modificar-proveedores.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
