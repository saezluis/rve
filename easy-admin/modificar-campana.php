      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Modificar campañas</h4>";
					echo "<p>Seleccione el ID de la campaña que desea modificar:</p>";
						...
						echo "<tbody>";
							...
							while($reg=mysqli_fetch_array($rss)){
								...
								echo "<tr>";
									...
									echo "<td><a class=\"equis\" href=\"modificar-campana-detalle.php?id_send=",urlencode($id_campana)," \">$id_campana</a></td>";
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='modificar-campana.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
