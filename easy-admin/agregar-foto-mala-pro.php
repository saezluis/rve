...
<?php
	...
	$xd = basename(@$_FILES["upload"]["name"]);
		...
		mysqli_query($conexion,"INSERT INTO fotos_practicas (nombre,id_proveedor,condicion) VALUES ('$newNameFinal','$id_proveedor','$condicion')") or die("Problemas con el insert de fotos");
	...
	<?php
		...
		echo "<form name=\"xyz\" method=\"post\" action=\"malas-practicas-pro.php\">";
