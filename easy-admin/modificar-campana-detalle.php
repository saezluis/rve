		...
		<div id="container">
			<div id="example">
				<?php			
					...
					$registrosTienda = mysqli_query($conexion," SELECT * from campana WHERE id_campana = $id_campana ") or die("Problemas en el select de tienda: ".mysqli_error($conexion));
					...
					*/	
					...
					if($regU=mysqli_fetch_array($registrosTienda)){
						...
						$nombre_campana = $regU['nombre'];						
					}
					
					echo "<form class=\"my-hero-form\" method=\"POST\" action=\"procesar-modificar-campana.php\">";
					echo "<input type=\"text\" name=\"id_send\" value=\"$id_campana\" hidden=hidden>";
					echo "Nombre sala: <input type=\"text\" name=\"nombre_campana\" value=\"$nombre_campana\" >";
					

					echo "<input type=\"submit\" value=\"Modificar\">";
					echo "<a class=\"cancel\" href=\"modificar-campana.php\">Volver</a>";
					echo "</form>";
