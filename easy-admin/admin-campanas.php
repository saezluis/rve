    ...
    <div class="ed-container">
      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="list-users">
				<?php			
					echo "<a href=\"consultar-campana.php\">Consultar campañas</a>";
					echo "<a href=\"agregar-campana.php\">Agregar campañas</a>";
					echo "<a href=\"modificar-campana.php\">Modificar campañas</a>";
					echo "<a href=\"eliminar-campana.php\">Eliminar campañas</a>";
				?>
			</div>			
		</div>		
     </div>
