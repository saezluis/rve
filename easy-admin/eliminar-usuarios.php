      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Eliminar usuarios</h4>";
					echo "<p>Seleccione el id del usuario que desea eliminar:</p>";
						...
						echo "<tbody>";
							...
							while($reg=mysqli_fetch_array($rss)){
								...
								echo "<tr>";
									...
									echo "<td><a class=\"equis\" href=\"eliminar-usuario-procesar.php?id_send=",urlencode($id)," \" onclick=\"return confirm('¿ Desea eliminar éste usuario ?')\">x</a></td>";
									echo "<td>$username</td>";
									echo "<td>$password</td>";
									echo "<td>$nombre</td>";
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='eliminar-usuarios.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
