...
<html ng-app lang="es">
  ...
  <body>
	<?php
		...
		$registrosTiendas = mysqli_query($conexion,"SELECT * FROM campana") or die("Problemas en el select de members: ".mysqli_error($conexion));
		...
		$num_total_registros = mysqli_num_rows($registrosTiendas); 
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='consultar-campana.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
