...
<html ng-app lang="es">
  ...
  <body>
	<?php
		...
		$registrosTiendas = mysqli_query($conexion,"SELECT * FROM sala") or die("Problemas en el select de members: ".mysqli_error($conexion));
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='consultar-tiendas.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
