...
<html ng-app lang="es">
  ...
  <body>
	<?php
		...
		$registrosMembers = mysqli_query($conexion,"SELECT * FROM campana") or die("Problemas en el select de sala: ".mysqli_error($conexion));
		...
		$ssql = "SELECT * FROM campana LIMIT " . $inicio . "," . $TAMANO_PAGINA; 
		//echo $ssql;
        ...
        <aside>
          ...
          <div class="aqui-les-va">
			...
			<div class="init_inicio">
					<form method="post" action="admin-campanas.php">
      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Eliminar campañas</h4>";
					echo "<p>Seleccione el ID de la campaña que desea eliminar:</p>";

					echo "<table class=\"pure-table\">";
						echo "<thead>";
							echo "<tr>";
								echo "<th>ID campaña</th>";
						...
						echo "<tbody>";
							...
							while($reg=mysqli_fetch_array($rss)){
								...
								$nombre_campana = $reg['nombre'];
								
								echo "<tr>";
									//echo "<div id=\"orden--6S\"><a href=\"modificar-oc-detalle.php?oc_send=",urlencode($n_orden)," \">Editar</a></div>";
									echo "<td><a class=\"equis\" href=\"eliminar-campana-procesar.php?id_send=",urlencode($id_campana)," \" onclick=\"return confirm('¿ Desea eliminar ésta campaña ?')\">x</a></td>";
									echo "<td>$nombre_campana</td>";									
								echo "</tr>";
							}
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='eliminar-campana.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
