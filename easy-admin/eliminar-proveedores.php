      ...
      <div class="ed-item base-80">
		...
		<div id="container">
			<div id="example">
				<?php			
					echo "<br>";					
					echo "<h4>Eliminar proveedores</h4>";
					echo "<p>Seleccione el ID del proveedor que desea eliminar:</p>";
					...
					echo "<table class=\"pure-table\">";
						...
						echo "<tbody>";
							...
							while($reg=mysqli_fetch_array($rss)){
								$id_proveedor = $reg['id_exhibicion'];
						...
						//muestro los distintos índices de las páginas, si es que hay varias páginas 
							...
							for ($i=1;$i<=$total_paginas;$i++){ 
								if ($pagina == $i) 
									...
									echo "<a href='eliminar-proveedores.php?pagina=" . $i . "'>"  . $i .  "</a> " ; 
								}   
							}	
						echo "</div>";				
					echo "</div>";
